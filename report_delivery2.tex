...
\subsubsection{ZipCode}
\begin{itemize}
    \item Each ZipCode is uniquely identifiable by the country and number. \\ CONSTRAINT PK\_ZipCode PRIMARY KEY (country, number)
...
\subsubsection{Address}
\begin{itemize}
    \item Each address is uniquely identified by its id. \\ CONSTRAINT PK\_Address PRIMARY KEY (idAddress)
...
\subsubsection{PostalService}
\begin{itemize}
    \item CONSTRAINT PK\_PostalService PRIMARY KEY (vat)
