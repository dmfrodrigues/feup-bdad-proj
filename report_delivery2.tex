...
A category is related with the class delivery, service and price. Corresponds to a classification of the package in which the item(s) is/are to be delivered and is characterized by a name out of three possibilities, having a maximum weight associated with each of them: it is classified as a Document if it weighs under 0.100kg, as Parcel if under 2.000kg or Overweight otherwise (up to 10.000kg).
\subsubsection{Service}
A service represents an option of delivery of an order, being identifiable by its name. \par
There are three types of services: Economy, Express and Registered.
\subsubsection{Price}
